...
class vxg_zoho_api extends vxg_zoho{
   public $token='' ; 
...
$objects=$arr['modules'];  
  ...
  if(is_array($objects)){
    ...
    $objects_f[$object['api_name']]=$object['plural_label'];   //var_dump($object);
         }
     }    
  }
 return $objects_f;   
...
//var_dump($arr);
$fields=array(); $req=array('Stage','Deal_Name');
...
//$extra['Add Tags']=$this->post_crm($camp_path,'post',json_encode(array('tags'=>array_map(function($val){return array('name'=>$val);}, array('test')) ))); 
//check primary key
 $extra=array();
